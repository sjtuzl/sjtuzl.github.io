---
layout: post
title: "Rational Software Architect 7.0"
date: 2006-12-12 22:23:10 +0800
permalink: /20061212/rational-software-architect-70.html
wp_id: 582
wp_slug: "rational-software-architect-70"
has_comments: true
---
{% raw %}
<div class="e-content">
<p>IBM最新版开发工具<a href="http://www-1.ibm.com/support/docview.wss?rs=2044&uid=swg24013690">Rational Software Architect 7.0</a>已于近日发布，新的V7版本集成了众多工具和企业、SOA开发的组件，整个产品共有12张CD（可以刻在一张D9上了）。</p>
<p>RSA V7包含的功能组件如下：</p>
<table width="100%" rules="all" frame="border" border="1" id="wq18">
<thead valign="bottom">
<tr>
<th align="left" id="wq19">功能部件</th>
<th align="left" id="wq20">描述</th>
</tr>
<tr>
...
<li class="comment">
  <div class="comment-meta"><span class="comment-author"><a href="http://www.laoxiong.cn" rel="nofollow noopener">老熊</a></span><time class="comment-date">2006-12-13 00:16:11</time></div>
  <div class="comment-body"><p>庞大，晕～～～</p></div>
</li>
<li class="comment">
  <div class="comment-meta"><span class="comment-author">Terry</span><time class="comment-date">2006-12-13 20:47:32</time></div>
  <div class="comment-body"><p>看来不支持SCA，和6.0功能没有太多变化嘛，出了支持WAS6.1</p></div>
</li>
<li class="comment">
  <div class="comment-meta"><span class="comment-author"><a href="http://blog.csdn.net/jaminwm" rel="nofollow noopener">jaminwm</a></span><time class="comment-date">2006-12-22 16:34:51</time></div>
  <div class="comment-body"><p>请问RSA7除了ECLIPSE和WAS61的不同外，其他的功能改进是否都可以在RSA6中以FIX或者更新/可选功能部件的方式可以实现呢？比如我的RSA+补丁001，002，003，003a是否就是RSA7了呢？</p></div>
</li>
<li class="comment">
  <div class="comment-meta"><span class="comment-author"><a href="http://blog.csdn.net/jaminwm" rel="nofollow noopener">jaminwm</a></span><time class="comment-date">2006-12-22 16:43:23</time></div>
  <div class="comment-body"><p>RSA7中期望解决2个问题：<br>
1：能够直接象ROSE2003一样有个菜单选项可以直接生成SoDA文档，老版本有，新版本居然没有。虽然SoDA7很不错，但是觉得此功能应该保留，你看人家ReqPro7都保留了此功能。<br>
2：保证一台机器能够同时安装RSA和其他IBM软件，比如：WebSphere Business Modeler Advanced Version 6.0.1。这两个软件都是我每日必要的，可惜却要用2台机器了，IBM软件又大又要求机器高配，我的T43P不可能买2台吧，和谐社会啊创建节约型社会IBM要做贡献啊</p></div>
</li>
<li class="comment">
  <div class="comment-meta"><span class="comment-author"><a href="http://www.zhangling.org/" rel="nofollow noopener">Zhang Ling</a></span><time class="comment-date">2006-12-22 17:34:27</time></div>
  <div class="comment-body"><p>RSA 7不可以从RSA 6直接update获得（001, 002等等是V6的更新）；</p>
<p>RSA和WBM有冲突，还是你需要同时运行这两个应用？同时跑的确够呛。</p></div>
</li>
<li class="comment">
  <div class="comment-meta"><span class="comment-author">hgx</span><time class="comment-date">2007-01-03 22:54:03</time></div>
  <div class="comment-body"><p>trial license只能使用30天,这个如何解决?</p></div>
</li>
<li class="comment">
  <div class="comment-meta"><span class="comment-author">Eric</span><time class="comment-date">2007-04-10 11:58:42</time></div>
  <div class="comment-body"><p>IBM热聘Rational人才<br>
工作内容：为全球Rational客户提供solution, consultancy, technical support 等工作.<br>
应聘要求：<br>
1. 熟悉IBM Rational两个以上的模块；<br>
2. 英语良好，可作为工作语言；<br>
3. 良好的沟通能力和团队协作精神。<br>
简历接受地址：huangcdl@cn.ibm.com<br>
(张岭兄，借宝地一用，且勿删除。)</p></div>
</li>
</ol>
</section>
{% endraw %}
